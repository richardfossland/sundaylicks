...
export default function SubmitPage() {
  return (
    <main className="mx-auto max-w-4xl px-4 py-6 sm:py-10">
      <Link href="/utforsk" className="mb-6 inline-flex items-center gap-1.5 text-sm text-[var(--color-muted)] hover:text-[var(--color-ivory)]">
        <ArrowLeft className="h-4 w-4" /> Utforsk
      </Link>
